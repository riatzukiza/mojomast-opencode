...
describe("Modifier Utility", () => {
  ...
  test("matchesShortcut should handle platform differences", () => {
    ...
    const macEvent = {
      ...
      altKey: false,
      shiftKey: false,
      getModifierState: () => true, // Mock getModifierState to always return true for Meta
    } as unknown as KeyboardEvent
    ...
    const winEvent = {
      ...
      altKey: false,
      shiftKey: false,
      getModifierState: () => true, // Mock getModifierState to always return true for Control
    } as unknown as KeyboardEvent
